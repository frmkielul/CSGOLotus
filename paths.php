    ...
    <header>
      <?php
          if(!isset($_SESSION["steamid"])) {
              ...
              echo '<div id="userinfo"><img id= "avatar" src="'.$steamprofile["avatar"].'"class="img-rounded">Welcome, <span>' . $steamprofile['personaname'] . '</span><div id="icon" data-toggle="modal" data-target="#settings"><a href="#"><i class="fa fa-cog"></i></a></div></div>';
          }
      ?>
    </header>
    </div>
